...
* **番茄发布**(release版本)：把本地章节送进番茄后台，少点一点是一点。
* **番茄同步**(release版本)：本地和网页章节对一对，不一致就揪出来。
* **小说处理**(personl版本)：整理 TXT、识别章节、格式化文本、按章节/章节数/大小/行数分割小说。
* **网页抓取**(personl版本)：抓章节、存 TXT、顺便清理一下乱七八糟的东西。
* **角色素材**(personl版本)：整理角色资料，把人物设定转成更方便复用的提示词素材。
* **当前剧情**(personl版本)：管理当前剧情上下文，让下一章能接得上前文正在发生的事。
