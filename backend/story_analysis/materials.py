...
@dataclass(slots=True)
class CharacterNotesReport:
    output_path: Path
    stats: CharacterNotesStats
...
def build_material_stats(materials: list[CharacterNote]) -> CharacterNotesStats:
